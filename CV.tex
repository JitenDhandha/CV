...
% Start of white papers
    November 2025 &
    E. de Lera Acedo et al. \textit{21 cm Cosmology from Space: A UK Path via CosmoCube}, UK Space Frontiers 2035 (in prep.)\\

    November 2025 &
    J. Chluba et al. \textit{Opening a New Window for Cosmology with CMB Spectral Distortions}, UK Space Frontiers 2035 (in prep.)\\

    November 2025 &
    A. Mesinger et al. \textit{Synergies for the Epoch of Reionization and Cosmic Dawn}, Advancing Astrophysics: Preparing for Science with the SKAO (in prep.)\\
% End of white papers
\end{longtable}
