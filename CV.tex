...
\usepackage{needspace} % for non-breaking titles and their content
...
\subsection*{Conference, Workshop and Meeting organization}

\begin{longtable}{L!{\vrule}R}

  March 2026 - \textit{present} & 21-cm Meeting Series, co-organiser of bi-weekly meetings at KICC, University of Cambridge, focused on the cosmological 21-cm signal and related topics. \\

  May 2026 & \href{https://www.kicc.cam.ac.uk/events/kavli-science-themed-meetings/galaxies-and-21-cm-frontier}{Galaxies and the 21-cm Frontier: Unveiling the Epoch of Reionization} (Kavli Science Focus), member of Organising Committee and session chair, KICC, University of Cambridge. \\

  July 2025  & Radio cosmology and science with the 21-cm signal (one day workshop), member of Organising Committee and session chair, KICC, University of Cambridge. \\

  February 2024 & \href{https://www.kicc.cam.ac.uk/events/kavli-science-themed-meetings/science-21-cm-hydrogen-line}{Science with the 21-cm line} (Kavli Science Focus), member of Organising Committee and session chair, KICC, University of Cambridge. \\
...
\begin{longtable}{L!{\vrule}R}
    ...
    April 2026 & \textit{Constraining Galaxies in the Early Universe using 21-cm and Multi-Wavelength Synergies} (virtual), State of the Universe (SOTU) seminar, DTP, TIFR-Mumbai. \\

    November 2025 & \textit{Narrowing the discovery space of the cosmological 21-cm signal using multi-wavelength constraints}, Weekly seminar, Institut d'Astrophysique Spatiale, Université Paris-Saclay. \\

    September 2025 & \textit{An overview of 21-cm cosmology and how we can constrain the discovery space of the 21-cm signal} (virtual), 8th Global 21-cm Workshop, California Institute of Technology. \\

    October 2022 & \textit{Can accreting primordial black holes explain the excess radio background?} (virtual), Weekly webinar, PDAT Laboratory, K. N. Toosi University of Technology. \\
...
\begin{longtable}{L!{\vrule}R}
    ...
    March 2026 & \textit{Narrowing the discovery space of the cosmological 21-cm signal using multi-wavelength constraints}, Cosmology in the Alps 2026, Les Diablerets, Switzerland. \\
    ...
    October 2024 & \textit{Constraining star-formation efficiency in the early Universe using JWST and the cosmic 21-cm signal}, Introduction to KICC, Kavli Institute for Cosmology, University of Cambridge. \\
    ...
    February 2024 & \textit{Synergies between 21-cm experiments and JWST observations}, One day workshop: Science with the 21-cm line, Kavli Institute for Cosmology, University of Cambridge. \\
...
\begin{longtable}{L!{\vrule}R}
    ...
    April 2026 & \textit{Narrowing the discovery space of the cosmological 21-cm signal using multi-wavelength constraints}, NenuFAR Cosmic Dawn plenary, Kavli Institute for Cosmology, University of Cambridge. \\
    ...
    September 2025 & \textit{What do we know about the 21-cm signal so far?}, Gravitational Wave Astrophysics Group group meeting (headed by Prof. Michela Mapelli), Centre for Astronomy of Heidelberg University. \\
...
I have \textbf{3 first author} publications and \textbf{14 contributing author} publications.
...
% Start of first author papers 
    December 2025 & \textbf{J. Dhandha}, A. Fialkov, T. Gessey-Jones, H. T. J. Bevins, S. Tacchella, S. Pochinda, E. de Lera Acedo, S. Singh, R. Barkana, \href{https://ui.adsabs.harvard.edu/abs/2025MNRAS.544.1608D}{\textit{Narrowing the discovery space of the cosmological 21-cm signal using multi-wavelength constraints}}, Monthly Notices of the Royal Astronomical Society, 544, 1608 \\

    September 2025 & \textbf{J. Dhandha}, A. Fialkov, T. Gessey-Jones, H. T. J. Bevins, S. Tacchella, S. Pochinda, E. de Lera Acedo, S. Singh, R. Barkana, \href{https://ui.adsabs.harvard.edu/abs/2025MNRAS.542.2292D}{\textit{Exploiting synergies between JWST and cosmic 21-cm observations to uncover star formation in the early Universe}}, Monthly Notices of the Royal Astronomical Society, 542, 2292 \\

    April 2024 & \textbf{J. Dhandha}, Z. Faes, R. J. Smith, \href{https://ui.adsabs.harvard.edu/abs/2024MNRAS.529.4699D}{\textit{Decaying turbulence in molecular clouds: how does it affect filament networks and star formation?}}, Monthly Notices of the Royal Astronomical Society, 529, 4699 \\
...
% Start of contributing author papers 
    June 2026 & S. A. K. Leeney et al., \href{https://ui.adsabs.harvard.edu/abs/2026arXiv260616525L}{\textit{Scalable Bayesian data curation for next-generation radio experiments}}, arXiv e-prints, arXiv:2606.16525 \\

    April 2026 & J. Wasserman, E. Zackrisson, \textbf{J. Dhandha}, A. Fialkov, L. Noble, S. Majumdar, \href{https://ui.adsabs.harvard.edu/abs/2026MNRAS.547ag386W}{\textit{Ultraviolet photon production rates of the first stars: Impact on the He II $\lambda$ 1640 Å emission line from primordial star clusters and the 21-cm signal from cosmic dawn}}, Monthly Notices of the Royal Astronomical Society, 547, stag386 \\

    April 2026 & S. Dasgupta, B. Liu, A. Fialkov, F. Deng, \textbf{J. Dhandha}, R. Barkana, \href{https://ui.adsabs.harvard.edu/abs/2026arXiv260411542D}{\textit{Impact of Stochastic Pop~III X-ray Binaries on the Cosmological 21-cm Signal}}, arXiv e-prints, arXiv:2604.11542 \\

    March 2026 & A. K. Dash et al., \href{https://ui.adsabs.harvard.edu/abs/2026arXiv260400105D}{\textit{Optimisation of calibration sources for global 21-cm experiments: the REACH case}}, arXiv e-prints, arXiv:2604.00105 \\

    February 2026 & Z. Abdurashidova et al., \href{https://ui.adsabs.harvard.edu/abs/2026ApJ...998...33A}{\textit{First Results from HERA Phase II}}, The Astrophysical Journal, 998, 33 \\

    --- 2026 & G. V. C. Allen et al., \href{https://ui.adsabs.harvard.edu/abs/2026JAI....1550002A}{\textit{Circuit Modeling for In Situ 21 cm Radiometer Calibration}}, Journal of Astronomical Instrumentation, 15, 2650002-70 \\

    October 2025 & S. Munshi, F. G. Mertens, J. K. Chege, L. V. E. Koopmans, A. R. Offringa, B. Semelin, R. Barkana, \textbf{J. Dhandha}, A. Fialkov, R. Mériot, S. Sikder, A. Bracco, S. A. Brackenhoff, E. Ceccotti, R. Ghara, S. Ghosh, I. Hothi, M. Mevius, P. Ocvirk, A. K. Shaw, S. Yatawatta, P. Zarka, \href{https://ui.adsabs.harvard.edu/abs/2025MNRAS.542.2785M}{\textit{Improved upper limits on the 21-cm signal power spectrum at z = 17.0 and z = 20.3 from an optimal field observed with NenuFAR}}, Monthly Notices of the Royal Astronomical Society, 542, 2785 \\

    August 2025 & B. Liu, D. Kessler, T. Gessey-Jones, \textbf{J. Dhandha}, A. Fialkov, Y. Sibony, G. Meynet, V. Bromm, R. Barkana, \href{https://ui.adsabs.harvard.edu/abs/2025MNRAS.541.3113L}{\textit{Effects of chemically homogeneous evolution of the first stars on the 21-cm signal and reionization}}, Monthly Notices of the Royal Astronomical Society, 541, 3113 \\

    March 2025 & O. S. D. O'Hara, Q. Gueuning, E. de Lera Acedo, F. Dulwich, J. Cumner, D. Anstey, A. Brown, A. Fialkov, \textbf{J. Dhandha}, A. Faulkner, Y. Liu, \href{https://ui.adsabs.harvard.edu/abs/2025MNRAS.538...31O}{\textit{Uncovering the effects of array mutual coupling in 21-cm experiments with the SKA-Low radio telescope}}, Monthly Notices of the Royal Astronomical Society, 538, 31 \\

    February 2025 & S. Pochinda, \textbf{J. Dhandha}, A. Fialkov, E. de Lera Acedo, \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250200852P}{\textit{Cosmological super-resolution of the 21-cm signal}}, Accepted at NeurIPS 2024 (Machine Learning and the Physical Sciences Workshop), arXiv:2502.00852 \\

    September 2024 & O. S. D. O'Hara, F. Dulwich, E. de Lera Acedo, \textbf{J. Dhandha}, T. Gessey-Jones, D. Anstey, A. Fialkov, \href{https://ui.adsabs.harvard.edu/abs/2024MNRAS.533.2876O}{\textit{Understanding spectral artefacts in SKA-Low 21-cm cosmology experiments: the impact of cable reflections}}, Monthly Notices of the Royal Astronomical Society, 533, 2876 \\

    May 2024 & A. Fialkov, T. Gessey-Jones, \textbf{J. Dhandha}, \href{https://ui.adsabs.harvard.edu/abs/2024RSPTA.38230068F}{\textit{Cosmic mysteries and the hydrogen 21-cm line: bridging the gap with lunar observations}}, Philosophical Transactions of the Royal Society of London Series A, 382, 20230068 \\

    December 2022 & S. K. Acharya, \textbf{J. Dhandha}, J. Chluba, \href{https://ui.adsabs.harvard.edu/abs/2022MNRAS.517.2454A}{\textit{Can accreting primordial black holes explain the excess radio background?}}, Monthly Notices of the Royal Astronomical Society, 517, 2454 \\

    February 2022 & S. Badole, D. Venkattu, N. Jackson, S. Wallace, \textbf{J. Dhandha}, P. Hartley, C. Riddell-Rovira, A. Townsend, L. K. Morabito, J. P. McKean, \href{https://ui.adsabs.harvard.edu/abs/2022A&A...658A...7B}{\textit{High-resolution imaging with the International LOFAR Telescope: Observations of the gravitational lenses MG 0751+2716 and CLASS B1600+434}}, Astronomy and Astrophysics, 658, A7 \\
% End of contributing author papers
\end{longtable}

\Needspace{3\baselineskip}
\subsection*{White Papers / Reports / Book Chapters}

\begin{longtable}{L!{\vrule}R}
% Start of white papers
    June 2026 &
    A. Mesinger et al., \href{https://ui.adsabs.harvard.edu/abs/2026arXiv260630947C}{\textit{Synergies for the Epoch of Reionization and Cosmic Dawn}}, Advancing Astrophysics with the SKA II (AASKAII), 2026\\

    November 2025 &
    E. de Lera Acedo et al., \textit{21 cm Cosmology from Space: A UK Path via CosmoCube}, UK Space Frontiers 2035 \\

    November 2025 &
    J. Chluba et al., \textit{Opening a New Window for Cosmology with CMB Spectral Distortions}, UK Space Frontiers 2035 \\
% End of white papers
\end{longtable}
