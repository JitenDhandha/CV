...
\usepackage{multicol} % for multiple columns in sections
...
\item Analytic and semi-numerical modelling
\item Simulation acceleration
\item Machine learning 
\item Bayesian inference
\item Multi-wavelength synergies
\end{itemize}
\end{multicols}
...
% Start of first author papers 
    March 2025 &
    \textbf{J. Dhandha}, T. Gessey-Jones, H. T. J. Bevins, S. Pochinda, A. Fialkov, S. Tacchella, E. de Lera Acedo, S. Singh, R. Barkana
    \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250321687D}{\textit{Exploiting synergies between JWST and cosmic 21-cm observations to uncover star formation in the early Universe}},
    arXiv e-prints, arXiv:2503.21687 \\
...
% Start of contributing author papers 
    ...
    \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250710533M}{\textit{Improved upper limits on the 21-cm signal power spectrum at $z=17.0$ and $z=20.3$ from an optimal field observed with NenuFAR}},
    arXiv e-prints, arXiv:2507.10533 \\
...
\begin{tabular}{L!{\vrule}R}
	...
	Oct. 2024 - \textit{present} & \textbf{Co-Supervision: Jacques Valkenberg} (MPhil. student) with Prof. Anastasia Fialkov and Dr. Sandro Tacchella. Work on studying the impact of metal enrichment and Population~II stellar IMF on the 21-cm signal of neutral hydrogen. \\

	Oct. 2024 - \textit{present} & \textbf{Co-Supervision: Kyle Wong} (Part~III student) with Prof. Anastasia Fialkov. Work on studying the impact of varying cosmology and matter power spectrum on the 21-cm signal of neutral hydrogen. \\

	Oct. 2023 - \textit{Jul. 2024} & \textbf{Co-Supervision: Rachel Incley} (Part~III student) with Prof. Anastasia Fialkov. Work on comparison of Epoch of Reionization in simulation codes \texttt{21cmSPACE} and \texttt{C2-Ray}. \\
