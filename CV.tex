...
% Start of first author papers 
    ...
    \href{https://ui.adsabs.harvard.edu/abs/2025MNRAS.544.1608D}{\textit{Narrowing the discovery space of the cosmological 21-cm signal using multi-wavelength constraints}},
    Monthly Notices of the Royal Astronomical Society, 544, 1608-1626 \\
...
% Start of contributing author papers 
    ...
    \href{https://ui.adsabs.harvard.edu/abs/2026MNRAS.547ag386W}{\textit{Ultraviolet photon production rates of the first stars: Impact on the He II $\lambda 1640 \r{A}$ emission line from primordial star clusters and the 21-cm signal from cosmic dawn}},
    Monthly Notices of the Royal Astronomical Society, 547, stag386 \\

    March 2026 &
    G. V. C. Allen et al.
    \href{https://ui.adsabs.harvard.edu/abs/2026arXiv260315072A}{\textit{Circuit Modeling for In Situ 21 cm Radiometer Calibration}},
    arXiv e-prints, arXiv:2603.15072 \\

    February 2026 &
    Z. Abdurashidova et al.
    \href{https://ui.adsabs.harvard.edu/abs/2026ApJ...998...33A}{\textit{First Results from HERA Phase II}},
    The Astrophysical Journal, 998, 33 \\
